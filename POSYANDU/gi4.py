...
ais = LINE('EuTocbUM3trfq3Yoqtn9.P1b3iWrd2siq32zyb7EHMq.gjo3ebF7oe9LA/QNvF5NQ54Rb+Hvhp2EAdxqy8qhjsw=')
ais.log("Auth Token : " + str(ais.authToken))
channelToken = ais.getChannelResult()
ais.log("Channel Token : " + str(channelToken))

ki2 = LINE('EunTA0eE8B0XCU3s8Pr3.r289V5XUsKocrPgbPDRhCW.0k6zHXKL0LEV4Kxz5UGCLwpwCrKxTn2QqYcwB1hV6nY=')
ki2.log("Auth Token : " + str(ki2.authToken))
channelToken = ki2.getChannelResult()
ki2.log("Channel Token : " + str(channelToken))

ki3 = LINE('EuOwhJq6GjjC5MEusfSb.jn9k0zvvZzxZUimhe8LFsW.HpKr4FEczLD7oG89oSsmpncYyAY+QCVk7gvK7Q6qIYI=')
ki3.log("Auth Token : " + str(ki3.authToken))
channelToken = ki3.getChannelResult()
ki3.log("Channel Token : " + str(channelToken))

ki4 = LINE('EuL7U8XROdv0ShwTmZBe.T91wWzzC3lw+noVY0yN23G./HhWyBmA6X2Lb0JiGf7F5ganMAUZ8nTGQd/v7Ev7Rk4=')
